	...
	<div class="row justify-content-between introduction">
		<div class="col-md-3">
			<div class="card card-medium">
				...
				<div class="card-body">
					<h5 class="card-title"><strong class="green">ಸಮಕಾಲೀನ</strong><br /> ಪ್ರತಿಮೆಗಳ ರಾಜಕಾರಣ</h5>
			...
			<div class="card card-medium">
				...
				<div class="card-body">
					<h5 class="card-title"><strong class="green">ಸಮಕಾಲೀನ</strong><br /> ಸಿದ್ದರಾಮಯ್ಯನವರ ಕಲ್ಯಾಣ ರಾಜ್ಯ !</h5>
		...
		<div class="col-md-3">
			<div class="card card-medium">
				...
				<div class="card-body">
					<h5 class="card-title"><strong class="blue">ಜಗದರಿವು</strong><br /> ಡೊನಾಲ್ಡ್ ಟ್ರಂಪ್ ಮತ್ತು ಅಮೆರಿಕಾದ ವರ್ಣೀಯ ರಾಜಕಾರಣ</h5>
			...
			<div class="card card-medium">
				...
				<div class="card-body">
					<h5 class="card-title"><strong class="red">ಸಂಸ್ಕೃತಿ ಸಂಪದ</strong><br /> ‘ಗೋತ್ರಾನೂ ಒಂದ ಧೋತ್ರಾನೂ ಒಂದ...’</h5>
